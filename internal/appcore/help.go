...
func actionDescription(action Action) string {
	descriptions := map[Action]string{
		...
		ActionEnterVisualBlock:      "Enter VISUAL (block) mode",
		...
		ActionJumpMatchingBrace:     "Jump to matching brace",
		...
		ActionFuzzyFinderCycleRoot:  "Cycle fuzzy root",
		ActionOpenBufferSwitcher:    "Open buffer switcher",
		ActionBufferSwitcherConfirm: "Confirm buffer switch",
		ActionOpenCommandPalette:    "Open command palette",
		ActionCommandPaletteConfirm: "Confirm command selection",
